...
import 'package:gistol_dashboard/features/exams/screens/exams_screen.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/no-internet',
        builder: (context, child) => NoInternetScreen(),
      ),
      GoRoute(
        path: '/no-connection',
        builder: (context, child) => NoConnectiontScreen(),
      ),
      ShellRoute(
